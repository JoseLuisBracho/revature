...
public class PlayerSearchServiceImpl implements PlayerSearchServive {
	...
	public List<Player> getPlayersByPosition(String position) throws BusinessException {
		...
		if (position != null && position.matches("[a-zA-Z]{5,20}")) {
			...
			throw new BusinessException("Entered Player Position " + position + " is INVALID");
		}
	...
	public List<Player> getPlayersByTeamName(String teamname) throws BusinessException {
		// TODO Auto-generated method stub
		List<Player> playersTeamnameList = null;
		
		if (teamname != null && teamname.matches("[ a-zA-Z]{4,35}")) {
			//Code for DAO
			playersTeamnameList = playerSearchDAO.getPlayersByTeamName(teamname);
			
		} else {
			throw new BusinessException("Entered Player Team Name " + teamname + " is INVALID");
		}

		return playersTeamnameList;
	}
	...
	public List<Player> getPlayersByName(String playername) throws BusinessException {
		...
		if (playername != null && playername.matches("[ a-zA-Z]{5,20}")) {
			...
			throw new BusinessException("Entered Player Name " + playername + " is INVALID");
		}
	...
	public List<Player> getPlayersByDob(String dob) throws BusinessException, ParseException {
		...
		if (dob != null && dob.matches("[0-9]{2}/[0-9]{2}/[0-9]{4}")) {
			...
			throw new BusinessException("Entered Player' Birthday " + dob + " is INVALID");
		}
